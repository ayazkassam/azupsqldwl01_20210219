CREATE VIEW [stage_metrix].[v_fact_source_metrix_inventories_incr]
AS select *
from (
	...
	from [stage_metrix].t_stg_metrix_participant_availables_incr pa
	left outer join ( 
	...
	left outer join metrix.BATTERY_MASTERS bm on f.ENTITY_ID = bm.BATTERY_FACILITY_ID and pa.PRODUCTION_DATE = bm.PRODUCTION_DATE
