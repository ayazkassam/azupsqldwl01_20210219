CREATE VIEW [stage_metrix].[v_fact_source_metrix_sales_incr] AS SELECT cast(convert(varchar(8), EOMONTH(cast(cast(sd.production_date as varchar) + '01' as datetime)), 112) as int) AS activity_period
...
FROM ( 
		select production_date
			...
			, actual_gigajoules
	from stage_metrix.t_stg_metrix_sales_details_incr sd
