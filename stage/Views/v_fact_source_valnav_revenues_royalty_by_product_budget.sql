CREATE VIEW [stage].[v_fact_source_valnav_revenues_royalty_by_product_budget]
...
(
	SELECT entity_id ,
        ...
        scenario_type,
		normalized_time_key
	from [stage].v_fact_source_valnav_royalty_by_product_calculations_budget,
...
(
 SELECT entity_id,
		...
		cad
 from [stage].v_fact_source_valnav_royalty_by_product_calculations_budget
UNPIVOT (cad FOR royalty_type IN 
             (crown_royalty, gor_royalty, freehold_royalty, indian_royalty, mineral_tax_royalty, sask_cap_surcharge_royalty
