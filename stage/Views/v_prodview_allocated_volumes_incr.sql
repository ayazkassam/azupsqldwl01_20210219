CREATE VIEW [stage].[v_prodview_allocated_volumes_incr] AS SELECT distinct 
    pu.idflownet
...
join stage_prodview.t_pvt_pvflownetheader fh on pz.idflownet = fh.idflownet
...
and cast(pz.dttm as date) >= cast(fh.syslockdatemaster - 35 as date);