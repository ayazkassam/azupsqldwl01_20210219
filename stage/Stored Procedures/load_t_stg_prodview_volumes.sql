CREATE PROC [Stage].[load_t_stg_prodview_volumes] AS
	SET NOCOUNT ON;

	BEGIN TRY

	truncate table [Stage].t_stg_prodview_volumes_final
	BEGIN TRANSACTION
		/*====================================================================================================================*/
		/*					split volumes between Raw Production and Sales Production										  */
		/*====================================================================================================================*/
		insert into [Stage].t_stg_prodview_volumes_final
		...
		SELECT site_id,
			   ...
			   joints_to_fluid,
			   bsw
		FROM stage.v_stg_prodview_volumes		
		...
		select count(*) INSERTED from [Stage].t_stg_prodview_volumes_final
