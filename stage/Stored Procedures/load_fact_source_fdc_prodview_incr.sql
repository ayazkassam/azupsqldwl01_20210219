CREATE PROC [stage].[load_fact_source_fdc_prodview_incr] AS
BEGIN
	...
	truncate table stage.t_fact_source_fdc_prodview_incr

	BEGIN TRANSACTION

	insert into stage.t_fact_source_fdc_prodview_incr
	SELECT site_id,
		   uwi,
		   cc_num,
		   activity_date_key,
		   ...
		   joints_to_fluid,
		   bsw
	FROM stage.t_stg_prodview_volumes_final_incr
	...
	SELECT site_id,
		   ...
		   joints_to_fluid,
		   bsw
	FROM stage.t_stg_prodview_volumes_final_incr pgf
	JOIN (
