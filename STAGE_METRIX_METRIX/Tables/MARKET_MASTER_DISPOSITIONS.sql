CREATE TABLE [STAGE_METRIX_METRIX].[MARKET_MASTER_DISPOSITIONS] (
    ...
    [DELIVERY_SEQUENCE]              NUMERIC (2)   NOT NULL,
    [DELIVERY_SYSTEM_PRIORITY]       NUMERIC (2)   NOT NULL,
    [SYSTEM_GENERATED]               VARCHAR (1)   NOT NULL,
    [FACILITY_SYS_ID]                NUMERIC (16)  NOT NULL,
    [DESTINATION_FACILITY_SYS_ID]    NUMERIC (16)  NULL,
    [PRODUCT_CODE]                   VARCHAR (16)  NOT NULL,
    [DISPOSITION_TYPE_CODE]          VARCHAR (16)  NOT NULL,
