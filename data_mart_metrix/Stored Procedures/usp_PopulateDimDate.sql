CREATE PROC [data_mart_metrix].[usp_PopulateDimDate] @piStartYear [INT],@piNumYears [INT] AS
BEGIN
   ...
   delete from [data_mart_metrix].t_DIM_DATE
   ...
   begin
      ...
      INSERT [data_mart_metrix].t_dim_date(
                        date_key, 
                        full_DATE,
						day_of_month,
						day_of_month_dd,
