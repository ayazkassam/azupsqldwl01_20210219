CREATE PROC [data_mart].[valnav_load_base_decline_production_metrics] AS
BEGIN
...
BEGIN TRY	
    ...
    BEGIN TRANSACTION
	   DELETE FROM [data_mart].t_fact_valnav_production
	...
	-- Insert New Transactions 
	   ...
	   INSERT INTO [data_mart].t_fact_valnav_production
	   SELECT entity_key,
			  activity_date_key,
			  account_key,
			  ...
			  'I' as ETL_status
	   FROM [stage].v_fact_source_valnav_production_base_decline_final
	   GROUP BY entity_key,
			  activity_date_key,
			  account_key,
			  reserve_category_id,
