CREATE PROC [data_mart].[full_valnav_fdc_facts_daily] AS
BEGIN
...
--	COMMIT TRANSACTION
 ...
 --       SELECT 
	...
	--			 src.scenario_key
	--	FROM 
	--		[stage].[t_fact_source_fdc_valnav_volumes_daily] src
	...
	--WHERE
	--		data_type='VALNAV-DAILY'


	--INSERT INTO [data_mart].[t_fact_fdc]
	--(
	--	site_id, gas_metric_volume, gas_imperial_volume, gas_boe_volume,gas_mcfe_volume, oil_metric_volume,               
